...
public class Test {
	...
	public static void main(String[] args) {
		String texto = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has "
		...
		String cadenaFinal = subCadena.substring(0, posicionPrimerPunto);
